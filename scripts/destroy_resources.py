...
def destroy_resources():
    ...
    destroy_pulumi_stack("EC2_Dev", "AWS-Resource-Management")
    ...
    destroy_pulumi_stack("S3_Dev", "AWS-Resource-Management")
    ...
    destroy_pulumi_stack("Route53_Dev", "AWS-Resource-Management")
