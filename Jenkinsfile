pipeline {
    ...
    parameters {
        ...
        string(name: 'TYPE', defaultValue: '', description: 'Instance Type (for create-instances)')
        string(name: 'OS', defaultValue: '', description: 'OS Type (for create-instances)')
        string(name: 'COUNT', defaultValue: '1', description: 'Number of instances to create')
